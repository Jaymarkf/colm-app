...
<x-layout>
    ...
    <div class="section bg-white">
        <div class="bg-cover bg-center bg-no-repeat h-96 flex items-center justify-center" style="background-image: url('{{asset('images/pre-elementary-bg.jpg')}}');background-attachment:fixed;">
            <h1 style="font-family:'Copperplate Gothic Bold', Courier, monospace;" class="text-5xl font-bold text-white text-center drop-shadow">
              Pre Elementary
            </h1>
        </div>
    </div>
    <div class="programs-content">
        <div class="card-container">
            ...
            <div class="p-5">
                <a href="#">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Pre Elementary 1</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Pre Elementary 1 Description Lorem upsim dolor amet dit dolor qit dotl qunatam tqun quantum</p>
